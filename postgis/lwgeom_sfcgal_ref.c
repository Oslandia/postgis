...
_SFCGAL_REF_WRAPPER_UNARY_PREDICATE( has_plane, sfcgal_geometry_is_planar )
...
_SFCGAL_REF_WRAPPER_UNARY_CONSTRUCTION( tesselate, sfcgal_geometry_tesselate )
_SFCGAL_REF_WRAPPER_UNARY_CONSTRUCTION( triangulate, sfcgal_geometry_triangulate_2dz )
_SFCGAL_REF_WRAPPER_UNARY_CONSTRUCTION( make_solid, sfcgal_geometry_make_solid )
_SFCGAL_REF_WRAPPER_UNARY_CONSTRUCTION( force_lhr, sfcgal_geometry_force_lhr )
